    ...
    <section className="w-full our-clients-section">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex justify-center mt-10 reveal-on-scroll">
          <Link
            href="/testimonials"
            className="flex items-center gap-2 px-5 py-3 bg-primary-light text-white rounded-[40.06px] text-sm font-semibold font-sans hover:bg-primary transition-all duration-300"
          >
